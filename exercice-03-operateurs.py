...
print ("bob distribura ", candies_per_person, " bonbons par personne")
print ("bob distribura ", chocolates_per_person, " chocolats par personne")
...
x = ((1+1+2+3+5+8+13)/ 7)
print ("la moyenne des nombres 1,1,2,3,5,8,13 est égal à :",x)
...
print ("montant total depensé :",total,"euros")
print ("moyenne des depenses :",average,"euros")
...
print("le montant de la tva est :", (price * tax_rate / 100))
...
print ("le prix TVA incluse est :", (price * (1 + tax_rate / 100)))
